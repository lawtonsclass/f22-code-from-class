...
_start:
  // let's print a prompt to stdout
  mov r7, #4 // write syscall is #4
  mov r0, #1 // file #1 is stdout
  ldr r1, =prompt // addr of string goes into r1
  ...
  ldr r1, =initials // addr of string to write to goes into r1
  mov r2, #4 // we're getting 4 characters (3 initials and a newline)
  swi 0 // run the syscall I just set up

  // let's print what is stored in intials
  mov r7, #4 // write syscall is #4
  mov r0, #1 // file #1 is stdout
  ldr r1, =initials // addr of string goes into r1
  ...
  ldr r1, =initials
  ldrb r2, [r1] // r2 = *r1 (first char is now in r2)
  strb r2, [r0] // *r0 = r2 (first character has been put in initials_with_dots)

  // next char to write is r0 + 2
  add r0, r0, #2
  // next char to read is r1 + 1
  add r1, r1, #1
  ldrb r2, [r1]
  strb r2, [r0]
  ...
  mov r7, #4 // write syscall is #4
  mov r0, #1 // file #1 is stdout
  ldr r1, =initials_with_dots // addr of string goes into r1
