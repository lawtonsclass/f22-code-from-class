...
_start:
  // let's capitalize the csci string stored in the .data section!

  // load the address of the csci string in r0
  ...
  // let's print our csci string to stdout
  mov r7, #4 // write syscall is #4
  mov r0, #1 // file #1 is stdout
  ldr r1, =csci // addr of string goes into r1
