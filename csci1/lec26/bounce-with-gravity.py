...
# should be/where it should move to
...
def drawFrame():
    ...
    # print("current velocity:", turtle_velocity)
    ...
    if turtle_y <= -200 + turtle_width/2:
        ...
        turtle_velocity = 26.0 # perfectly elastic collision: always bounce upward at 26 units/frame
